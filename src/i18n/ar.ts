export const strings = {
  ...
  loginTitle: 'سجّل دخولك لمتابعة استخدام التطبيق',
  syncNow: 'مزامنة الآن',
  ...
  offlineStatus: 'غير متصل — سيُزامَن عند عودة الاتصال',
  syncNotConfigured: 'المزامنة السحابية غير مُعدّة على هذا الإصدار',
  pendingItems: 'عناصر بانتظار المزامنة',
  retry: 'إعادة المحاولة',
  goalContributions: 'مساهمات الأهداف',
  debtPayments: 'دفعات الديون',
} as const
